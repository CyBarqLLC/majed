...
EN = {
    ...
    "nav": [("#top", "Home"), ("#works", "Works"), ("#about", "About"),
            ("#athar", "Athar"), ("contact.html", "Contact")],
...
""".format(lang=t["lang"], dir=t["dir"], title=title, desc=desc, canonical=canonical,
           base=BASE_URL,
           ar_path=("index.html" if page == "home" else "contact.html"),
           en_path=("en/index.html" if page == "home" else "en/contact.html"),
...
def navbar(t, page, alt_href):
    def links(cls):
        ...
        for href, label in t["nav"]:
            h = href
            if page == "contact":
                h = t["home_href"] + href if href.startswith("#") else href
            current = ' aria-current="page"' if (
                page == "contact" and href == "contact.html") else ""
...
if __name__ == "__main__":
    ...
    for u in ["", "contact.html", "en/", "en/contact.html"]:
